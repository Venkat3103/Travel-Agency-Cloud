...
class Coorg extends React.Component {

    state = {
        tiers: [
            {
                title: 'Abbey Falls',
                description: ['A refreshing waterfalls present amidst the thick jungle area. Walk over the hanging bridge to experience this thing of beauty!'],
                buttonText: 'View Details',
                buttonVariant: 'outlined',
                placeid: 'ChIJV5w-GRcBpTsRKVB_6YY-RGM'
            },
            {
                title: 'Nagarhole National Park',
                description: [
                    'This national park is the home to rare breed of species such as the Asian Elephants and the Indian Tigers. Come and coexist with nature!',
                ],
                placeid: 'ChIJpxdr0qzDpTsRaRj8MT75vkA',
                buttonText: 'View Details',
                buttonVariant: 'outlined',
            ...
            },
            {
                title: "Raja's Seat",
                description: [
                    'Seat of the King is a seasonal garden of flowers and artificial fountains',
                ],
                placedetails: 'ChIJLQdDhJiqpTsRDCb18aqAbLc',
                buttonText: 'View Details',
                buttonVariant: 'outlined',
            },
            {
                title: 'Forest Valley Treehouse',
                description: ['Dwell in the company of nature in our tree houses'],
                placeid: 'ChIJ3dnDHr2qpTsRMPjFkNYGXMY',
                buttonText: 'View Details',
                buttonVariant: 'outlined',
            },
...
export default withStyles(styles, { withTheme: true })(Coorg);