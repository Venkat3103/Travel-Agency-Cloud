...
class Shimla extends React.Component {
    ...
    state = {
        tiers: [
            {
                title: 'Rohtang La',
                description: ['One of the highest passes in the Himalayas and the major attraction of the city. You would not want to miss this!'],
                buttonText: 'View Details',
                buttonVariant: 'outlined',
                placeid: "ChIJrRV6svB-BDkRa8bv72V-3b8"
            },
            {
                title: 'Solang Nala',
                description: [
                    'Its all covered with Ice as far as you can see. The main hub for many adventure sports. This is your skiiing destination!!',
                ],
                placeid: "ChIJY4Ki1yCHBDkRaEWS0dZeQr0",
                buttonText: 'View Details',
                buttonVariant: 'outlined',

            },
            {
                title: 'Gulaba View Point',
                description: ['A beautiful village where you can experience the much enjoyed snowfall in the city of Shimla'],
                placeid:"ChIJoW3q-ViHBDkRftuah-Ik8Do",
                buttonText: 'View Details',
                buttonVariant: 'outlined',
            },
            {
                title: 'Hotel - Sterling Manali',
                description: ['Vibrant rooms, some with mountain views, in a modern resort with a bright restaurant'],
                placeid:"ChIJXTxwBoBbVToR6z6brnZy_SU",
                buttonText: 'View Details',
                buttonVariant: 'outlined',
            },
        ...
        return (
            <React.Fragment>
                ...
                <Typography component="h1" variant="h6" align="center" color="textPrimary" gutterBottom>
                    ...
                    <Button fullWidth color="primary" onClick={()=>{window.open('https://travelagencybucket.s3.amazonaws.com/SHI105.pdf')}} >
                        Download Itinerary
                    </Button>
                </Container>
                {/* End hero unit */}
